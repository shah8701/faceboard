...
namespace faceboardpro
{
    ...
    public sealed class FBGlobals
    {
        ...
        public readonly string AccountVerificationLoginPhpAttempt = "https://www.facebook.com/login.php?login_attempt=1";
        ...
        public readonly string fdhomepath = @"C:\faceboardpro";
        public readonly string fddatapath = @"C:\faceboardpro\Data";
        public readonly string fddbfilename = @"\faceboardpro.db";
